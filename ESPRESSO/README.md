...
Espresso is a two level logic minimizer developed in University of California, Berkeley.
...
Running espresso w/o any output filter produces a more machine readable format: [This is probably the output you'll want to pipe into your scripts to generate verilog.]
